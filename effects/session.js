...
const createSession = exports.createSession = (dispatch, params, extras) => {
  return api(dispatch, '/sessions?select=refresh_token,user_id,jwt', {
    ...
    return api(dispatch, `/users?select=id,email,first_name,last_name,username,phone_verified,voter_status,update_emails_preference,address:user_addresses(id,address)&id=eq.${user_id}`, {
