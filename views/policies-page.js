    ...
    <section class="section">
      <div class="container is-widescreen">
        ...
        <div class="content">
          ...
          <p>Privacy and security are critical priorities.</p>
          ...
          <ul>
            ...
            <li>We will never share your email address with anyone else. Democracy.space and the author of a petition you signed may email you updates from time to time. You can unsubscribe at any time.</li>
        ...
        <div class="content">
          ...
          <p>Democracy.space is an online community hub where we come together to debate critical issues facing our country and communities. We can introduce legislation, read different perspectives on issues and endorse those that most closely resonates, share our opinions, and/or proxy our vote to trusted personal representatives.</p>
          ...
          <p>Our mission at Democracy.space is to put systems — both technological and human — that bring fairness and transparency to working through content and appropriateness disputes. We’ll always consider suggestions for improvement, though may not always implement them.</p>

          <p>Ultimately, all questions related to content moderation and user participation are the discretion of Democracy.space. We generally attempt to work with users to remove questionable content and address any problems, and reserve the right to impose penalties, including temporary or permanent restrictions from parts of the service.</p>
        </div>
      </div>
    </section>
  `
