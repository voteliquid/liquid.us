module.exports = {
  ...
  '/legislation/:short_id': route('Legislation', () => import('./components/LegislationDetailsPage')),
  '/nominations/:short_id': route('Legislation', () => import('./components/NominationDetailsPage')),
  '/nominations/:short_id/vote': route('Legislation', () => import('./components/MeasureVotePage')),
  '/:username/legislation/:short_id': route('Legislation', () => import('./components/LegislationDetailsPage')),
