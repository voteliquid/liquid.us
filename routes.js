module.exports = {
  ...
  '/nominations/:short_id/votes/:comment_id': route('Nomination Comment', () => import('./components/EndorsementPage')),
  ...
  '/:username/legislation/:short_id/votes/:comment_id': route('Legislation', () => import('./components/EndorsementPage')),
  ...
  '/legislation/:short_id/votes/:comment_id': route('Bill Comment', () => import('./components/EndorsementPage')),
