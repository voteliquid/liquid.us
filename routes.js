module.exports = {
  ...
  '/:username/legislation': route('Your Proposed Legislation', () => import('./components/YourProposedLegislationPage')),
  '/:username/legislation/:short_id': route('Legislation', () => import('./components/LegislationPage')),
