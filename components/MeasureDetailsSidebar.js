        ...
        <div class="panel-heading has-text-centered">
          <h3 class="title has-text-weight-semibold is-size-5">
            <a href="${measureUrl}" class="has-text-dark">
              ${l.introduced_at ? `${l.short_id.replace(/^[^-]+-(\D+)(\d+)/, '$1 $2').toUpperCase()}` : (l.short_id === 'should-nancy-pelosi-be-speaker' || l.type === 'nomination' ? 'Proposed Nomination' : l.short_id === "terminating-a-national-emergency" ? 'H.J.Res. 46' : 'Proposed Legislation')}
            </a>
          </h3>
        ...
        <div style="width: 100%;">
          <div class="columns is-gapless is-multiline is-mobile">
            <div class="column is-one-third">
              <div class="has-text-grey">${short_id === "terminating-a-national-emergency" || introduced_at ? 'Introduced' : 'Proposed'}</div>
            </div>
            ...
            <div class="column is-two-thirds">
              <div class="has-text-right">
                ${short_id === "terminating-a-national-emergency" ? [`<a href="/JoaquinCastrotx">Joaquin Castro</a>`] : sponsor_username
