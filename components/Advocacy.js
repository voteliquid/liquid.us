...
module.exports = class AdvocacyPage extends Component {
  render() {
        ...
        <div class="container">
            <div class="content">
                ...
                <div class="columns">
                    <div class="column">
                        <figure class=".image">
                            <img src="/assets/scorecard.png" alt="United Scorecard" />
                        </figure>
                    </div>
                    <div class="column">
                        <p class="is-size-4">Your members want accountability, but phone calls stats aren’t transparent, and the legislative process is overly-complicated. <br><br> United.vote grades politicians on how well they listen to their constituents and gives your members an ongoing say on policy without being overwhelmed.</p>
                        <br>
    ...
    <section>
        <div class="container">
            <div class="content">    
                    <h1 class="title has-text-centered" style="margin-top: 80px">United adapts to any level of a member's participation</h2>
                    <div class="is-flex is-horizontal-center">
                        <ol class="is-size-3">
